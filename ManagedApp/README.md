...
In order to make your pipeline more relevant, see [capabilities](https://github.com/OfficeDev/ManagedAccessMSGraph/wiki/Capabilities)  for [user selection](https://github.com/OfficeDev/ManagedAccessMSGraph/wiki/Capabilities#user-selection), [filters](https://github.com/OfficeDev/ManagedAccessMSGraph/wiki/Capabilities#filters), other [datasets](https://github.com/OfficeDev/ManagedAccessMSGraph/wiki/Capabilities#datasets) and [data regions](https://github.com/OfficeDev/ManagedAccessMSGraph/wiki/Capabilities#data-regions).
...
1. On the **Basics** screen, select your subscription and either create a new resource group or use an existing one, then select **OK**.
   > **NOTE:** Please make sure that the location selected is one of the [Azure regions](https://github.com/OfficeDev/ManagedAccessMSGraph/wiki/Capabilities#data-regions) we support, since we are currently not available worldwide. For example "East US 2"
...
See here if you want to [Run](https://github.com/OfficeDev/ManagedAccessMSGraph/wiki/Azure-Data-Factory-Quick-Links#running-an-adf-pipeline), [Schedule](https://github.com/OfficeDev/ManagedAccessMSGraph/wiki/Azure-Data-Factory-Quick-Links#schedule-a-pipeline), [Monitor](https://github.com/OfficeDev/ManagedAccessMSGraph/wiki/Azure-Data-Factory-Quick-Links#monitor-a-pipeline) a pipeline or [Approve a Data Access Request](https://github.com/OfficeDev/ManagedAccessMSGraph/wiki/Approving-a-data-access-request)
